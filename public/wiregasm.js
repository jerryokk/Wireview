...
function findWasmBinary() {
    return 'https://wireview.github.io/wiregasm.wasm';
}
...
function invoke_iiiiiijii(index,a1,a2,a3,a4,a5,a6,a7,a8) {
  var sp = stackSave();
  try {
    return dynCall_iiiiiijii(index,a1,a2,a3,a4,a5,a6,a7,a8);
  } catch(e) {
    stackRestore(sp);
    if (e !== e+0) throw e;
    _setThrew(1, 0);
...
(() => {
  // Create a small, never-async wrapper around loadWiregasm which
  // checks for callers incorrectly using it with `new`.
  var real_loadWiregasm = loadWiregasm;
  loadWiregasm = function(arg) {
    if (new.target) throw new Error("loadWiregasm() should not be called with `new loadWiregasm()`");
    return real_loadWiregasm(arg);
  }
})();
if (typeof exports === 'object' && typeof module === 'object') {
  ...
  module.exports.default = loadWiregasm;
